...
public class Exercise2 {
    ...
    public void personHasNotEmptyLastNameAndFirstName() {
        ...
        Predicate<Person> validate = person -> !person.getLastName().trim().isEmpty() && !person.getFirstName().trim().isEmpty();
    ...
    public void personHasNotEmptyLastNameAndFirstNameUsingLogicalOperators() {
        Predicate<Person> personHasEmptyFirstName = person -> person.getFirstName().trim().isEmpty();
        Predicate<Person> personHasEmptyLastName = person -> person.getLastName().trim().isEmpty();
