...
public class Exercise1 {
    ...
    public void sameAgesCheckerUsingBiPredicate() {
        ...
        BiPredicate<Person, Person> sameAgesChecker =
                (firstPerson, secondPerson) -> Integer.compare(firstPerson.getAge(), secondPerson.getAge()) == 0;
    ...
    // TODO - возвращающий BiFunction, сравнивающий два объекта Person и возвращающий возраст того, чье полное имя длиннее.
     ...
     createExtractorAgeOfPersonWithTheLongestFullName(Function<Person, String> extractor) {
    ...
    public void getAgeOfPersonWithTheLongestFullName() {
        ...
        BiFunction<Person, Person, Integer> extractorAgeOfPersonWithTheLongestFullName =
                createExtractorAgeOfPersonWithTheLongestFullName(Person::getLastName);
