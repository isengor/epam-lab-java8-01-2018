...
public class Exercise1 {
    ...
    public void findFirstWithAge30UsingGuavaPredicate() {
        ...
        Predicate<Person> isAgeEqualsWhatWeNeed = new Predicate<Person>() {
            @Override
        ...
        Optional<Person> personOptional = FluentIterable.from(persons).firstMatch(isAgeEqualsWhatWeNeed);
